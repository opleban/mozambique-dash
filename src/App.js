        ...
        <Grid className="mz-section">
          <Col lg={12} md={12} sm={12} xs={12}>
            ...
            <div className="mz-section-text">
              <p>Despite its “blistering pace of economic growth” from 2006 to 2011<sup className="mz-reference" title="Hanlon, Joseph (19 September 2007). Is Poverty Decreasing in Mozambique?. Open University, England">[1]</sup>, Mozambique remains one of the poorest countries the world.</p>
              ...
              <p>The technical appendix can be found <a href="tech_appendix.pdf" target="_blank">here</a>.</p>
            </div>
          </Col>
        </Grid>
        <Grid className="mz-section">
          ...
          <h2 id="education" className="mz-section-header">
            ...
            <Col lg={12} md={12} sm={12} xs={12}>
              <div className="mz-section-text">
                ...
                <p>Education varies across gender. Over a third of adult women have never attended school versus less than one sixth of adult men who have never attended school. Lack of formal education is concentrated in rural areas. The heads of urban households see a higher level of education, with only 19.2% having no education; comparatively, 35% of the heads of rural households have never attended school. This, too, is amplified for the poor: rural and poor adults see the highest level of no schooling at 38.2%.</p>
              </div>
            </Col>
            <Col lg={12} md={12} sm={12} xs={12}>
